// ignore_for_file: non_constant_identifier_names, unused_local_v, unnecessary_null_comparison
import 'dart:io';
...
class HomeProvider {
  ...
  Future<String> updateProd(
    ...
    if (imgFile != null) {
      try {
        UploadTask task =
            FirebaseStorage.instance.ref().child(filename).putFile(imgFile);
        taskSnapshot = await task.whenComplete(() => null);
      } catch (e) {
        Get.snackbar('Erro', 'Falha no envio da imagem',
      ...
      if (taskSnapshot != null) {
        try {
          ...
          Get.snackbar('Sucesso', 'Produto alterado',
              backgroundColor: Colors.blue);
          return 'Sucesso';
        } catch (e) {
          Get.snackbar('Erro', 'Falha ao alterar produto',
              backgroundColor: Colors.red);
          return 'null';
        }
      }
    ...
    try {
      ...
      Get.snackbar('Sucesso', 'Produto alterado', backgroundColor: Colors.blue);
      return 'Sucesso';
    } catch (e) {
      Get.snackbar('Erro', 'Falha ao alterar produto',
          backgroundColor: Colors.red);
  ...
  Future<String> deleteProd(id) async {
    try {
      ...
      Get.snackbar('Sucesso', 'Produto excluído', backgroundColor: Colors.blue);
      return 'Sucesso';
    } catch (e) {
      Get.snackbar('Erro', 'Falha ao excluir produto',
          backgroundColor: Colors.red);
      return 'null';
    }
  }
